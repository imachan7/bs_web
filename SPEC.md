...
- 構造化の進捗: キーワード7枚＋赤・紫バッチ21枚（全文10・部分11。スキップ9枚の未対応概念は
  ...
  計 **88枚** / 効果文持ち128枚。
- **残り40枚は表示のみ（2026-07-21 時点）**。主な未対応概念は3クラスタに集約:
  ...
  (3) 粉砕連動フック（粉砕による破棄の検知・破棄枚数修正・粉砕持ちのレベル上書き。
  BS03-086/090/115/117）。ほか単発: 効果無効化・手札加入検知・player-choice可変数・
  相対レベル操作（ビルドアップ）・シンボル追加（ダブルハート）・破壊耐性など。
  再開時はこの3クラスタから優先度をつけて拡張する
