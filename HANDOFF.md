...
**第1バッチ8枚（043/044/045/048/049/050/109/111）は投入済み**（65d8e91）。BS10 は 91 / 121枚。
足した器は `AuraCounter.ownHand` と `discardBothHands.all?: true` の2つ。
...
**分け方**（同じファイルを触るので直列に流す。並列にしない）:
- **2a**: 041 / 042 / 091 / 093 — 既存軸の組み合わせと小さな拡張
- **2b**: 046 / 047 / 092 / 110 / X05 — 新機構。092 と X05 は軽減元の拡張を共有する
