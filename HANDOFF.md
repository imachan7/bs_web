...
| AI/AR 破壊待機からの復帰 | 白 067 | 黄 036/038/040/X05 | **黄の要求が広いので最初から一般形で作る**（§11.1 AR）。**⚠️ 作るとき紫 X02-e2 を `reviveOnDestroy` から AR へ移す＝ §8.3。既存の `reviveOnDestroy` 側も §1 #20 に合わせるかはユーザー確認が要る** |
