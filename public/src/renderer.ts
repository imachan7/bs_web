...
export function magicTargetSide(
    ...
    if (effect.action.type === "timedEffect" && effect.action.content.some((c) => c.type === "bp" || c.type === "keyword" || (c.type === "level" && c.up !== undefined) || (c.type === "triggerSwap" && c.from === "onAttack")) && !effect.action.all) {
