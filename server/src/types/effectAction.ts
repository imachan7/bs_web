...
export type EffectAction =
 ...
 | { type: "refreshSelf"; costReturnOwnBrave?: true; costSacrificeChosen?: true } // このスピリット自身を回復させる（selfがnull/既に回復状態ならno-op）。costReturnOwnBrave指定時は自身に合体しているブレイヴ1つを手札に戻すことがコスト。
