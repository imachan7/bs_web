...
export type EffectDef =
    ...
    | {
          ...
          levels: number[] | null
          target: "ownAll" | "chosenInstance" // chosenInstance＝targetChoiceLendThisTurnで選んだ1体だけ（陣営を問わない。source.lentChoiceInstanceIdで判定。BS12-081メロディアスハープ）
