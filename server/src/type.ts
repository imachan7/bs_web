...
export type EffectAction =
    ...
    | { type: "reviveLastDestroyedNexus" } // self上のコアすべてを自分のトラッシュに置くことで、直近に破壊された自分のネクサス（GameState.lastDestroyedNexus）をトラッシュから自分のフィールドへ戻す（コア0で戻る。selfが不在・コア0・対象なしなら不発。BS04戦闘獣ジャッカー）
